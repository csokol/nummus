...
in all web browsers. Service worker registration [won't be attempted](src/main/js/registerServiceWorker.js)
...
starting point, you can make use of the logic included in [`src/registerServiceWorker.js`](src/main/js/registerServiceWorker.js), which
